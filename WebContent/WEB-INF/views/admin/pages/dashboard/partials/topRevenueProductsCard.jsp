...
<div class="card border-0 shadow">
    <div class="card-header">
        <div class="row align-items-center">
            <div class="col">
                <h2 class="fs-5 fw-bold mb-0">Top doanh thu sản phẩm</h2>
            </div>
        ...
        <table class="table align-items-center table-flush" style="table-layout: fixed">
            ...
            <c:forEach items="${topRevenueProducts}" begin="0" end="4" var="product" varStatus="i">
            	<tr>
                    ...
                    <td class="fw-bolder text-gray-500 d-flex align-items-center">
                    	<c:set var="bouceRate" value="${product[0].getBounceRate(product[0].id)}"></c:set>
                    	<c:if test="${bouceRate > 0}">
                    		...
                    		<fmt:setLocale value="vi_VN" scope="session" />
                        	<fmt:formatNumber value="${bouceRate}" type="number" />%
                    	</c:if>
