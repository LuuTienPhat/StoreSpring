...
<div class="card border-0 shadow">
    ...
    <div class="card-body">
        <div class="list-group list-group-flush list my--3">
            <c:forEach items="${topFavoriteProducts}" var="product" varStatus="i" begin="0" end="6">
    ...
    <div class="card-footer border-top bg-gray-50">
    	<a class="fw-bold d-flex align-items-center justify-content-center" href="${applicationScope.topFavoriteProductsPage}">
