                ...
                <table class="table table-hover table-responsive" id = "datatable">
                    <thead class="thead-dark">
                        <tr>
                            ...
                            <th class="border-gray-200 text-wrap">Tên sản phẩm</th>						
                            <th class="border-gray-200 text-wrap">Số lượng trong kho</th>
                            <th class="border-gray-200 text-wrap">Số lượng yêu cầu</th>
                            <th class="border-gray-200 text-wrap">Đơn vị tính</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td><span class="fw-normal text-wrap">${detail.product.name}</span></td>
                            <td><span class="fw-bold text-wrap">${detail.product.quantity}</span></td>
                            <td><span class="fw-bold text-wrap">${detail.quantity}</span></td>                           
                            <td><span class="fw-normal text-wrap">${detail.product.unit}</span></td>
                            <td><span class="fw-bold text-wrap" >${detail.product.price}</span></td>
                           <%--  <td><span class="fw-normal text-wrap">${detail.product.description}</span></td> --%>
                            
                            <td><span class="fw-bold text-warning text-wrap">${detail.product.category.name}</span></td>
                            <%-- <td><span class="fw-normal text-wrap">${detail.product.dateAdded}</span></td> --%>
                            <c:choose>
							    <c:when test="${!detail.product.images.isEmpty()}">
							        <td><img src="data:image/png;base64,${detail.product.images.get(0).image}" width=100 height=100 alt="${detail.product.name}"/></td>
							    </c:when>    
							    <c:otherwise>
							       <td><span class="text-wrap"><img src="data:image/png;base64" alt="${detail.product.id}"/></span></td>
							    </c:otherwise>
							</c:choose>
