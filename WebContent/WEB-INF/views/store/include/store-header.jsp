...
<header class="header">
        <ul class="nav__top flex justify-end bg-indigo-300">
            <li><a href="#"
                    class="px-4 py-1 block font-bold hover:text-indigo-400 transition-colors">HỆ THỐNG CỬA
                    HÀNG</a></li>
            <li><a href="#" class="px-4 py-1 block font-bold hover:text-indigo-400 transition-colors">VỀ MOJI</a></li>
            <li><a href="#" class="px-4 py-1 block font-bold hover:text-indigo-400 transition-colors">TUYỂN DỤNG</a></li>
        </ul>
        <div class="nav__middle flex justify-between px-32 items-center">
            <div class="nav__middle-left flex justify-between items-center">
                <div class="mobile-menu-button test-ani cursor-pointer hidden">
                    <div class="bar-top bg-indigo-300">

                    </div>
                    <div class="bar-middle bg-indigo-300">

                    </div>
                    <div class="bar-bottom bg-indigo-300">
            ...
            <div class="flex justify-between nav__middle-right flex-1 items-center">
                <div class="nav__middle-bottom flex-1 mt-8">
                    <form action="store/search" method="get" class="flex border-2 border-indigo-400 rounded-r-lg rounded-l-lg overflow-hidden">
        ...
        <div class="nav__bottom flex items-center px-32 bg-indigo-300">
            ...
            <ul class="flex items-center">
                ...
                <li class="nav__submenu-container relative">
                    <div class="cursor-pointer px-2 py-3 flex justify-between border-b-2 border-white">
                        <a href="store/all" class="block font-bold text-sm hover:text-indigo-400 transition-colors">Tất cả</a>
                        <!-- <i class="fa fa-chevron-down flex-1 nav__submenu-container pr-2 hidden"></i> -->
                    </div>
                </li>
